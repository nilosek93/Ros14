...
class Creature : virtual public Thing {
	...
	public:
		...
		virtual bool isFollowingCreature(Creature* creature) {
			return followCreature == creature;
		}
		...
		virtual bool isAttackingCreature(Creature* creature) {
			return attackedCreature == creature;
		}
		...
		decltype(auto) getStorageMap() const {
			return storageMap;
		}
