...
ReturnValue Combat::canDoCombat(Creature* caster, Tile* tile, bool aggressive) {
	...
	return events::creature::onAreaCombat(caster, tile, aggressive);
}
...
void MagicField::onStepInField(Creature* creature) {
	...
	if (!isLoadedFromMap() && creature->getPlayer() && (id == ITEM_FIREFIELD_NOPVP || id == ITEM_FIREFIELD_NOPVP_MEDIUM|| id == ITEM_POISONFIELD_NOPVP || id == ITEM_ENERGYFIELD_NOPVP)) {
		if (!creature->isInGhostMode()) {
